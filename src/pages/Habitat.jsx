...
const sections = [
    {
        ...
        desc: "Grasswrens will happily roost in dense, thicket-like shrubbery and brush piles. Rock piles and wood piles are also good wren shelters. They will use roost boxes with 1.25-1.5-inch entrances. Because grasswrens can initially be shy, landscaping that creates corridors of dense shelter will help them move about the yard more comfortably. These birds can also be very creative about nesting spots. They may build nests in any suitable nook or cranny, such as flowerpots, coffee cans, shoes, on top of tires, or inside grill covers.",
        images: [
...
const stepsData = {
    ...
    WaterPlatform: [
        { step: "Step 1 for Water Platform", description: "Birds are drawn to water sources for both drinking and bathing, much like they are to feeders. You can set up a birdbath using either a purchased bird bath or simple dishes or shallow pans. While birds often prefer baths at ground level, raised baths can also attract them. It's important to change the water daily to maintain freshness and cleanliness. " },
        { step: "Step 2 for Water Platform", description: "If the bath is on the ground, consider placing a few branches or stones in the water to provide perches for birds to stand on while drinking without getting wet, especially during winter.        " },
        { step: "Step 3 for Water Platform", description: "To enhance the appeal of your birdbath, consider providing dripping water. You can purchase a dripper or sprayer, or you can repurpose an old bucket or plastic container by creating a small hole in the bottom, filling it with water, and suspending it above the birdbath to allow water to drip out.        " }
    ],
    Food: [
        { step: "Step 1 for Food", description: "Leave dead trees and limbs in place, if safe, as they host insects that are vital food sources for birds like woodpeckers, chickadees, and nuthatches. Plant native vines like Virginia creeper to beautify dead trees." },
        { step: "Step 2 for Food", description: "Use hulled sunflower seeds, which lack shells and reduce mess. Most seed-eating birds enjoy them, and they're easy to eat. Be sure to keep the seed dry because it tends to spoil more quickly than sunflower in the shell. Small pieces of shelled peanuts also attract grasswrens. Ensure they're mold-free and offer them on hopper or platform feeders.        " },
        { step: "Step 3 for Food", description: "Mealworms, these high-protein treats are larvae of the mealworm beetle. Offer live or dried mealworms on a tray or specialised feeder to attract birds. Berries can be attractive to grasswren; however, be sure to dispose of any fruit or berry that becomes moldy because some molds create toxins that are harmful to them.        " }
    ]
};
...
const HabitatPage = () => {
    ...
    const [showPreparationContent, setShowPreparationContent] = useState(false);
    ...
    return (
        <div className='flex flex-col bg-grey'>
            <div className='relative'>
                ...
                <img src={whiteLine} alt="White Line" className="absolute bottom-1/2 left-1/2 transform -translate-x-1/2 w-auto h-auto" />
                <h2 className="absolute bottom-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-4xl text-white font-Poppins tracking-widest">
                    Be A WrenGuard
                </h2>
            </div>
            <button onClick={handleQualifiedClick} className="btn-dark w-1/4 mx-auto my-10 py-4 rounded-lg">Am I qualified?</button>
            {showQualifiedContent && (
                <>
                    <div className='flex items-center justify-center'>
                        <div className='relative'>
                            <img src={leftBubble} alt="Left Bubble" className="w-auto h-auto object-cover" />
                            <p className="absolute top-1/3 left-[40%] transform -translate-x-1/2 -translate-y-1/2 text-2xl font-bold">
                                Did I pass the tests?
                            </p>
                            <Link to='/education/quiz' className="absolute top-1/2 left-[40%] transform -translate-x-1/2 -translate-y-1/2 btn-light mx-auto my-10 py-2">Do the Tests</Link>
                        </div>
                        ...
                        <div className='relative'>
                            ...
                            <p className="absolute top-1/2 left-[60%] transform -translate-x-1/2 -translate-y-1/2 text-2xl font-bold whitespace-nowrap">
                                I think I am ready!
                                <br />
                                Lets Do This!
                            </p>
                            ...
                            <div className='flex flex-col w-full'>
                                ...
                                <div className='grid grid-cols-2 gap-8'>
                                    ...
                                    <div className='flex flex-col my-2 p-2 rounded-lg border'>
                                        ...
                                        >
                                            <option value="" disabled>Select Gardening Skill</option>
                    ...
                    <button onClick={handlePreparationClick} className="btn-dark w-1/4 mx-auto my-10 py-4 rounded-lg">Start Preparation!</button>
                    {showPreparationContent && (
                        <>
                                    ...
                                    <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80%] px-20 py-10 rounded-3xl " style={{ backgroundColor: sections[currentSection].color }}>
                                        ...
                                        <div className='flex items-start justify-center gap-20 pt-20'>
                                            ...
                                            <div className='flex flex-row items-center justify-center gap-4 w-[50%]'>
                                                ...
                                                <div>
                                                    <img src={currentImages[currentImageIndex].src} alt="Section Image" className="w-96 h-96 rounded-full" />
                                                    <p className="text-white font-semibold text-xl text-center mt-5">{currentImages[currentImageIndex].desc}</p>
                                                </div>
                            ...
                            {/* <button className="btn-dark w-1/4 mx-auto my-10 py-4 rounded-lg">You Are Ready</button> */}
                            ...
                            <button onClick={handleHereWeGoClick} className="btn-dark w-1/4 mx-auto my-10 py-4 rounded-lg">Here we go!</button>
                            {showHereWeGoContent && (
                                <>
                                    <div className='flex items-center justify-center'>
                                        <div className='relative'>
                                            ...
                                            {showStepModal && (
                                                <div className="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center" onClick={(e) => setShowStepModal(false)}>
                                                    <div className="bg-white bg-opacity-75 w-1/3 h-1/2 p-5 rounded-lg shadow-lg flex flex-col" onClick={(e) => e.stopPropagation()}>
                                                        <div className='px-6'>
                                                            ...
                                                            <p className='text-xl'>{currentSteps[currentStepIndex].description}</p>
                                                        </div>
